...
// PyNetConnectorAdvanced Constructor
PYDOC(NetConnectorAdvanced_python, R"doc(
Operator taking RF data in UDP packets and outputting RFArray chunks.

**==Named Inputs==**

    burst_in : BurstParams
        Burst of packets coming from the advanced network operator.
